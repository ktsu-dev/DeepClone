...
- Fix IReadOnlyDictionary DeepClone throwing InvalidCastException ([@Claude](https://github.com/Claude))
...
- Update VERSION to 1.0.9 ([@matt-edmondson](https://github.com/matt-edmondson))
